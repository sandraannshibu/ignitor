...
public class Rateings extends AppCompatActivity implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rateings);
        ...
        B1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JR.json_response = (JsonResponse) Rateings.this;
                String q = "/rateings?rating=" + rat + "&log_id=" + sh.getString("log_id", "") +"&rid="+ UserViewordereditems.oid;
                q = q.replace(" ", "%20");
                JR.execute(q);
            }
        });
