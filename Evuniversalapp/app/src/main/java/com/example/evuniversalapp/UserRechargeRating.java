...
public class UserRechargeRating extends AppCompatActivity implements JsonResponse {
    RatingBar ratingbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_recharge_rating);
        ...
        B1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JR.json_response = (JsonResponse) UserRechargeRating.this;
                String q = "/rate?rating=" + rat + "&log_id=" + sh.getString("log_id", "") +"&rid="+ UserViewrechargerequests.rid;
                q = q.replace(" ", "%20");
                JR.execute(q);
            }
        });
