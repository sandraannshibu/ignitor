...
public class Deliverysendcomplaint extends AppCompatActivity implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deliverysendcomplaint);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(complaint.equalsIgnoreCase(""))
                {
                    ...
                    JR.json_response = (JsonResponse) Deliverysendcomplaint.this;
                    String q = "/boycomplaint?log_id=" + sh.getString("log_id", "") + "&complaint=" + complaint;
                    q = q.replace(" ", "%20");
                    JR.execute(q);
        ...
        JsonReq JR = new JsonReq();
        JR.json_response = (JsonResponse) Deliverysendcomplaint.this;
        String q ="/boyviewcomplaints?log_id=" +sh.getString("log_id", "");
        q = q.replace(" ","%20");
        JR.execute(q);
    }
