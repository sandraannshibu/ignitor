...
public class Deliverymanageprofile extends AppCompatActivity implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deliverymanageprofile);
        ...
        JR.json_response = (JsonResponse) Deliverymanageprofile.this;
        String q = "/ViewDeliverymanageprofile?lid="+sh.getString("log_id", "");
        q = q.replace(" ", "%20");
        JR.execute(q);
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(email.equalsIgnoreCase(""))
                {
                    ...
                    JsonReq JR = new JsonReq();
                    JR.json_response = (JsonResponse) Deliverymanageprofile.this;
                    String q = "/Deliverymanageprofile?login_id=" + sh.getString("log_id", "") + "&name=" + name + "&place=" + place + "&Phone=" + phone + "&email=" + email + "&lname=" + lname;
                    q = q.replace(" ", "%20");
                    JR.execute(q);
    ...
    public void response(JSONObject jo) {
        try {
            ...
            if(method.equalsIgnoreCase("ViewDeliverymanageprofile")) {
            ...
            else if(method.equalsIgnoreCase("Deliverymanageprofile"))
            {
                try {
                    String status=jo.getString("status");
                    Log.d("pearl",status);
