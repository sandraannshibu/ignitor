...
public class DeliveryAddpouduct extends AppCompatActivity implements JsonResponse {

    EditText e1,e2,e3;

    String Pname,rate,stock;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delivery_addpouduct);
        ...
        e3 = (EditText) findViewById(R.id.rate);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                rate = e3.getText().toString();

                if(Pname.equalsIgnoreCase(""))
                {
                    e1.setError("Enter your  product name");
                    e1.setFocusable(true);
                }
                else if(stock.equalsIgnoreCase(""))
                {
                    e2.setError("Enter your  stock");
                    e2.setFocusable(true);
                }
                else if(rate.equalsIgnoreCase(""))
                {
                    e3.setError("Enter your  rate");
    ...
    private void sendAttach() {
        ...
        try {
            ...
            String q = "http://" +Ipsettings.ip+"/api/Delivery_addproduct";
            ...
            aa.put("Pname",Pname.getBytes());
            aa.put("stock",stock.getBytes());
            aa.put("rate",rate.getBytes());

//                aa.put("log_id",sh.getString("log_id","").getBytes());
//            aa.put("house",house.getBytes());

            FileUploadAsync fua = new FileUploadAsync(q);
            fua.json_response = (JsonResponse) DeliveryAddpouduct.this;
            fua.execute(aa);
        } catch (Exception e) {
    ...
    private void selectImageOption() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(DeliveryAddpouduct.this);
...
//                sendAttach1();
    ...
    public void onBackPressed()
    {
        ...
        super.onBackPressed();
        Intent b=new Intent(getApplicationContext(),DeliveryBoyHome.class);
        startActivity(b);
    }
}
