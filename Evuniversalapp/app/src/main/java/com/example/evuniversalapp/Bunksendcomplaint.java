...
public class Bunksendcomplaint extends AppCompatActivity implements JsonResponse{
    EditText e1;
    Button b1;
    ListView l1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bunksendcomplaint);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(complaint.equalsIgnoreCase(""))
                {
                    ...
                    JR.json_response = (JsonResponse) Bunksendcomplaint.this;
                    String q = "/bunkcomplaint?log_id=" + sh.getString("log_id", "") + "&complaint=" + complaint;
                    q = q.replace(" ", "%20");
                    JR.execute(q);
        ...
        JsonReq JR = new JsonReq();
        JR.json_response = (JsonResponse) Bunksendcomplaint.this;
        String q ="/bunkviewcomplaints?log_id=" +sh.getString("log_id", "");
        q = q.replace(" ","%20");
        JR.execute(q);
    }
