...
public class UserMechanicRating extends AppCompatActivity implements JsonResponse {
    RatingBar ratingbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_mechanic_rating);
        ...
        B1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JR.json_response = (JsonResponse) UserMechanicRating.this;
                String q = "/mrateing?rating=" + rat + "&log_id=" + sh.getString("log_id", "") +"&rid="+ UserViewrequest.mid;
                q = q.replace(" ", "%20");
                JR.execute(q);
            }
        });
