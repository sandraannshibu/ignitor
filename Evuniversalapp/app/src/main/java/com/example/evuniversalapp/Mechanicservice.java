...
public class Mechanicservice extends AppCompatActivity implements JsonResponse {
    EditText e1;
    Button b1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mechanicservice);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(amount.equalsIgnoreCase(""))
                {
                    ...
                    JsonReq JR = new JsonReq();
                    JR.json_response = (JsonResponse) Mechanicservice.this;
                    String q = "/Mechanicservice?login_id=" + sh.getString("log_id", "") + "&amount=" + amount + "&rid=" + Mechanicviewrequest.mid;
                    q = q.replace(" ", "%20");
                    JR.execute(q);
