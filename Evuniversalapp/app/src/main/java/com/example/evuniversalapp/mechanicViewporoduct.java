...
public class mechanicViewporoduct extends AppCompatActivity implements JsonResponse, AdapterView.OnItemClickListener {
    ListView l1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JR.json_response = (JsonResponse) mechanicViewporoduct.this;
        String q = "/UserViewporoduct?log_id=" +sh.getString("log_id", "")+"&spid="+mechanicSearchspareparts.sid;
        q = q.replace(" ", "%20");
        JR.execute(q);
    }
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(mechanicViewporoduct.this);
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if (items[item].equals("Order Now")) {
                    ...
                    startActivity(new Intent(getApplicationContext(), mechanicOrderNow.class));
