...
public class Mechanicsendcomplaint extends AppCompatActivity implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mechanicsendcomplaint);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(complaint.equalsIgnoreCase(""))
                {
                    ...
                    JR.json_response = (JsonResponse) Mechanicsendcomplaint.this;
                    String q = "/Mechaniccomplaint?log_id=" + sh.getString("log_id", "") + "&complaint=" + complaint;
                    q = q.replace(" ", "%20");
                    JR.execute(q);
        ...
        JsonReq JR = new JsonReq();
        JR.json_response = (JsonResponse) Mechanicsendcomplaint.this;
        String q ="/Mechanicviewcomplaints?log_id=" +sh.getString("log_id", "");
        q = q.replace(" ","%20");
        JR.execute(q);
    }
