...
public class Mechanicpayment extends AppCompatActivity implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mechanicpayment);
        ...
        e3.setText(UserViewrequest.amt);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(cvv.equalsIgnoreCase("")|| cvv.length()!=3)
                {
                    ...
                    JR.json_response = (JsonResponse) Mechanicpayment.this;
                    String q = "/Mechanicpayment?login_id=" + sh.getString("log_id", "")+ "&amount=" + UserViewrequest.amt +"&rid=" +UserViewrequest.mid +"&name="+ name ;
                    q = q.replace(" ", "%20");
                    JR.execute(q);
                }
