...
public class VehicleRating extends AppCompatActivity implements JsonResponse {
    RatingBar ratingbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vehicle_rating);
        ...
        B1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JR.json_response = (JsonResponse) VehicleRating.this;
                String q = "/VehicleRating?rating=" + rat + "&log_id=" + sh.getString("log_id", "") +"&rid="+ UserViewbookings.rid;
                q = q.replace(" ", "%20");
                JR.execute(q);
            }
        });
