...
public class mechanicreg extends AppCompatActivity implements JsonResponse {
...
//                JR.json_response = (JsonResponse) mechanicreg.this;
//                String q = "/mechanicreg?fname=" + fname + "&lname=" + lname +"&place=" + place + "&phone=" + phone + "&email=" + email + "&username="+ username + "&password=" + password+"&lati="+LocationService.lati+"&logi="+LocationService.logi ;
//                q = q.replace(" ", "%20");
//                JR.execute(q);
//
//            }
//        });
    ...
    private void sendAttach() {
        ...
        try {
            ...
            String q = "http://" + Ipsettings.ip + "/api/mechanicreg";
...
//            aa.put("house",house.getBytes());
            ...
            fua.json_response = (JsonResponse) mechanicreg.this;
            fua.execute(aa);
        } catch (Exception e) {
    ...
    private void selectImageOption() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(mechanicreg.this);
