...
public class Usermakepayments extends AppCompatActivity implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usermakepayments);
        ...
        e3.setText(sh.getString("total",""));

//        e3.setText(UserViewordereditems.amt);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(cvv.equalsIgnoreCase("")|| cvv.length()!=3)
                {
                    ...
                    JR.json_response = (JsonResponse) Usermakepayments.this;
                    String q = "/Makepayments?login_id=" + sh.getString("log_id", "")+"&book_id=" + sh.getString("ordermaster_id","")+ "&amts=" + sh.getString("total","") +"&name="+ name ;
                    q = q.replace(" ", "%20");
                    JR.execute(q);
                }
