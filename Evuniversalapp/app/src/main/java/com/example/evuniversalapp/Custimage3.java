...
public class Custimage3 extends ArrayAdapter<String>  {
	...
	private String[] image;
	 ...
	 public Custimage3(Activity context, String[] fname, String[] lname, String[] place , String[] phone, String[] email, String[] image ) {
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
			...
			t1.setText("Sparepart Name: : "+fname[position]+"\nSparepart last Name: : "+lname[position]+"\nplace:"+place[position]+"\nphone:"+phone[position]+"\nemail:"+email[position]);
